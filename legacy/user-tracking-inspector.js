...
function extractToteInfo(page) {
  ...
  const statusSelector = isAftliteNa ? 'body > table:nth-child(6) > tbody > tr:nth-child(2)' : 'div.a-row:nth-child(6)'
  const completionTimeSelector = isAftliteNa
    ? 'body > table:nth-child(6) > tbody > tr:nth-child(6)'
    : 'div.a-row:nth-child(10)'
  const cptSelector = isAftliteNa ? 'body > table:nth-child(6) > tbody > tr:nth-child(8)' : 'div.a-row:nth-child(12)'
