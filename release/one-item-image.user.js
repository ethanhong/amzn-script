...
// @updateURL    https://ethanhong.github.io/amzn-tools/release/one-itme-image.user.js
// @downloadURL  https://ethanhong.github.io/amzn-tools/release/one-itme-image.user.js
// @supportURL   https://github.com/ethanhong/amzn-tools/issues
// ==/UserScript==

// eslint-disable-next-line func-names
;(function () {
  const tds = document.querySelectorAll('#main-content > table.a-bordered.aft-collated-picklist td')
